...
# nltk.download('averaged_perceptron_tagger')a

# # Load the saved model
# model_path = os.path.join(os.path.dirname(__file__), 'calibrated_gb_model.joblib')
...
#         # Simple TF-IDF approximation for single sentence
